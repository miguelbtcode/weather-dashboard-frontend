      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-secondary-700/30 p-4 rounded-xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-3xl font-medium">{chanceOfRain ? `${Math.round(chanceOfRain * 100)}%` : '0%'}</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <span className="block text-right text-sm text-secondary-400">
                {uvi < 3 ? 'Low' : uvi < 6 ? 'Moderate' : uvi < 8 ? 'High' : 'Very High'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-secondary-700/30 p-4 rounded-xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              <span className="text-3xl font-medium">{Math.round(wind_speed)}</span>
